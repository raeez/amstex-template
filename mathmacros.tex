...
\nc\laurentser[1]{\llp#1\rrp}
\nc\fpowerser[1]{\llb#1\rrb}
\nc\klocint{\grk\fpowerser{z}}
\nc\Klocfrac{K\laurentser{z}}
\nc\tensor{\otimes}
...
\nc\disj{\bigsqcup} % TODO distinguish bigsqcup and sqcup
\nc\bij{\leftrightarrow}
\nc\surj{\twoheadedrightarrow}
